...
public class SaveModuleToFile extends RecordingCommand {
	...
	protected void doExecute() {
		...
		if (module instanceof edu.kit.archicorc2.Verification.Compound) {
			edu.kit.archicorc2.Verification.Compound comp = (edu.kit.archicorc2.Verification.Compound) module;
