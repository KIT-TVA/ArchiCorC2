...
public class FOLZ3Parser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "'_'", "'\"'", "'['", "';'", "','", "']'", "'.'", "TYPE", 
		"'\\true'", "'\\false'", "'.$'", "'\\null'", "QUANTIFER", "OPERATOR", 
		"COMPONENT", "STRING", "IDENTIFIER", "NUMBER", "'('", "'!'", "')'", "'^'", 
		"'=='", "'+'", "'-'", "'*'", "'/'", "CHARACTER", "'&&'", "'||'", "'=>'", 
		"'<>'", "'>'", "'<'", "'<='", "'>='", "WHITESPACE"
	};
	public static final int
	...
	public final FormulaContext formula() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				{
				setState(52); tupelformula();
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(53); connectiveformula();
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(54); quantifier();
				}
				break;
			case 5:
				enterOuterAlt(_localctx, 5);
				{
				setState(55); operatorformula();
				}
				break;
			case 6:
				enterOuterAlt(_localctx, 6);
				{
				setState(56); pred_constant();
	...
	public final QuantifierContext quantifier() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(70); match(QUANTIFER);
			setState(72);
			_la = _input.LA(1);
			if (_la==TYPE) {
				{
				setState(71); match(TYPE);
				}
			}
	...
	public final ConnectiveformulaContext connectiveformula() throws RecognitionException {
		...
		try {
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << CONJ) | (1L << DISJ) | (1L << IMPL) | (1L << BICOND))) != 0)) {
				{
				{
				setState(108); connectoperator();
				setState(109); compareformula();
				}
				}
				setState(115);
				_errHandler.sync(this);
	...
	public final CompareformulaContext compareformula() throws RecognitionException {
		...
		try {
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << EQUAL) | (1L << GREATER) | (1L << SMALLER) | (1L << SMALLEREQ) | (1L << GREATEREQ))) != 0)) {
				{
				{
				setState(126); compoperator();
				setState(127); summformula();
				}
				}
				setState(133);
				_errHandler.sync(this);
	...
	public final SummformulaContext summformula() throws RecognitionException {
		...
		try {
			...
			while (_la==ADD || _la==MINUS) {
				{
				{
				setState(146); addoperator();
				setState(147); faktorformula();
				}
				}
				setState(153);
				_errHandler.sync(this);
	...
	public final FaktorformulaContext faktorformula() throws RecognitionException {
		...
		try {
			...
			while (_la==MULTI || _la==DIVISION) {
				{
				{
				setState(155); multoperator();
				setState(156); powerformula();
				}
				}
				setState(162);
				_errHandler.sync(this);
	...
	public final PowerformulaContext powerformula() throws RecognitionException {
		...
		try {
			...
			while (_la==POWER) {
				{
				{
				setState(164); match(POWER);
				setState(165); notterm();
				}
				}
				setState(170);
				_errHandler.sync(this);
	...
	public final TermContext term() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(176); compproperty();
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(177); portproperty();
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
	...
	public final ArrayContext array() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				{
				setState(201); match(COMPONENT);
				setState(202); match(CODEWORD);
				}
				}
				break;
			case 2:
	...
	public final ComppropertyContext compproperty() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(223); match(COMPONENT);
			setState(224); match(CODEWORD);
	...
	public static final String _serializedATN =
		...
		"\3\17\5\17\u00da\n\17\3\17\3\17\6\17\u00de\n\17\r\17\16\17\u00df\3\20"+
		"\3\20\3\20\3\20\3\21\3\21\3\21\3\21\5\21\u00ea\n\21\3\22\3\22\3\22\6\22"+
		"\u00ef\n\22\r\22\16\22\u00f0\3\23\3\23\3\23\3\23\3\23\3\23\5\23\u00f9"+
		...
		"\u012a\2\60\3\2\2\2\4F\3\2\2\2\6H\3\2\2\2\b^\3\2\2\2\nm\3\2\2\2\fx\3\2"+
		"\2\2\16\177\3\2\2\2\20\u0088\3\2\2\2\22\u0093\3\2\2\2\24\u009c\3\2\2\2"+
		"\26\u00a5\3\2\2\2\30\u00b0\3\2\2\2\32\u00c9\3\2\2\2\34\u00d3\3\2\2\2\36"+
		"\u00e1\3\2\2\2 \u00e5\3\2\2\2\"\u00eb\3\2\2\2$\u00f2\3\2\2\2&\u0106\3"+
		"\2\2\2(\u0108\3\2\2\2*\u010a\3\2\2\2,\u010c\3\2\2\2.\u010e\3\2\2\2\60"+
		"\61\5\4\3\2\61\3\3\2\2\2\62\63\7\4\2\2\63\64\5\4\3\2\64\65\7\4\2\2\65"+
		"G\3\2\2\2\66G\5\f\7\2\67G\5\n\6\28G\5\6\4\29G\5\b\5\2:;\5.\30\2;<\7\25"+
		"\2\2<A\5\32\16\2=>\7\6\2\2>@\5\32\16\2?=\3\2\2\2@C\3\2\2\2A?\3\2\2\2A"+
		...
