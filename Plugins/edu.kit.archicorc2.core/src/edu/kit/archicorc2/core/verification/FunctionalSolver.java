...
public class FunctionalSolver implements IViewpointSolver {
	...
	public boolean checkRealizability(Module component) {
		...
		for (Abstract m : component.getRealizedBy()) {
			...
			List<edu.kit.archicorc2.Verification.Property> list = getConstraints(m);
			envproperty.addAll(replaceEnvNamesFunc(list, m));
			List<edu.kit.archicorc2.Verification.Property> list2 = getConstraints(component);
...
//					}
	...
	List<String> replaceEnvNamesFunc(List<edu.kit.archicorc2.Verification.Property> prop, Module m) {
	...
	public List<edu.kit.archicorc2.Verification.Property> getConstraints(Module m) {
		List<edu.kit.archicorc2.Verification.Property> constraints = new ArrayList<edu.kit.archicorc2.Verification.Property>();
		if (m.getIsPartOf() != null) {
			constraints = getConstraints(m.getIsPartOf());
		}
		for (edu.kit.archicorc2.Verification.Property p : m.getEnviromentalProperties()) {
			boolean found = false;
