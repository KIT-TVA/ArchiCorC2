...
public class CreateModule extends RecordingCommand {
	...
	protected void doExecute() {
		...
		if (this.type == CreationType.COMPONENT) {
			...
			edu.kit.archicorc2.Verification.Compound c = MmFactory.eINSTANCE.createCompound();
			creat.setNewObject(c);
			c.setName(file.getName().substring(0, dot));
			c.setModule(null);
			c.setModuleType(MmFactory.eINSTANCE.createFunction());
			...
			edu.kit.archicorc2.Verification.Abstract c = MmFactory.eINSTANCE.createAbstract();
			creat.setNewObject(c);
			c.setName(file.getName().substring(0, dot));
			c.setModule(null);
			c.setModuleType(MmFactory.eINSTANCE.createFunction());
			...
			edu.kit.archicorc2.Verification.System s = MmFactory.eINSTANCE.createSystem();
