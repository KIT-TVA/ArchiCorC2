package edu.kit.archicorc2.edl.parser.antlr.internal;
        ...
        try {
            ...
            state._fsp--;
            					...
            					set(
            						...
            						"name",
            						lv_name_2_0,
            						"edu.kit.archicorc2.edl.Events.FQN");
            	...
            	case 1 :
            	    ...
            	    state._fsp--;
            	    					...
            	    					add(
            	    						...
            	    						"imports",
            	    						lv_imports_3_0,
            	    						"edu.kit.archicorc2.edl.Events.Import");
            	    					afterParserOrEnumRuleCall();
            	...
            	case 1 :
            	    ...
            	    state._fsp--;
            	    					...
            	    					add(
            	    						...
            	    						"edu.kit.archicorc2.edl.Events.EventType");
            	    					afterParserOrEnumRuleCall();
        ...
        try {
                ...
                case 1 :
                    ...
                    state._fsp--;
                    					...
                    					set(
                    						...
                    						"comment",
                    						lv_comment_1_0,
                    						"edu.kit.archicorc2.edl.Events.AnnotationBlock");
                    					afterParserOrEnumRuleCall();
            ...
            state._fsp--;
            					...
            					add(
            						...
            						"events",
            						lv_events_5_0,
            						"edu.kit.archicorc2.edl.Events.Event");
            					afterParserOrEnumRuleCall();
            ...
            switch (alt6) {
                case 1 :
                    ...
                    lv_default_2_0=(Token)match(input,18,FOLLOW_2); 
                    						...
                    						setWithLastConsumed(current, "default", lv_default_2_0 != null, "default");
            	...
            	case 1 :
            	    ...
            	    state._fsp--;
            	    					...
            	    					add(
            	    						...
            	    						"elements",
            	    						lv_elements_1_0,
            	    						"edu.kit.archicorc2.edl.Events.Annotation");
            	    					afterParserOrEnumRuleCall();
        ...
        try {
            ...
            lv_rawText_0_0=(Token)match(input,RULE_ANNOTATION_STRING,FOLLOW_2); 
            				...
            				setWithLastConsumed(
            					...
            					"rawText",
            					lv_rawText_0_0,
            					"edu.kit.archicorc2.edl.Events.ANNOTATION_STRING");
                ...
                case 1 :
                    ...
                    state._fsp--;
                    							...
                    							set(
                    								...
                    								"edu.kit.archicorc2.edl.Events.ImportedFQN");
                    							afterParserOrEnumRuleCall();
