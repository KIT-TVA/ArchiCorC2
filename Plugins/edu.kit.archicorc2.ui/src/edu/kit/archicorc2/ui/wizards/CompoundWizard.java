...
public class CompoundWizard extends Wizard implements INewWizard {
	private CompoundWizardPage page;
	private ISelection selection;

	/**
	 * Constructor for SampleNewWizard.
	 */
	public CompoundWizard() {
		super();
	...
	public void addPages() {
		page = new CompoundWizardPage(selection);
		addPage(page);
	}
	...
	private void doFinish(String containerName, String fileName, IProgressMonitor monitor) throws CoreException {
		...
		CreateModule operation = new CreateModule(editingDomain, containerName, fileName, uri, CreationType.COMPOUND);
