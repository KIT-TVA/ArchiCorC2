package edu.kit.archicorc2.edl.ide.contentassist.antlr.internal;
...
public class InternalEventsLexer extends Lexer {
    ...
    public final void mT__12() throws RecognitionException {
        try {
            ...
            // InternalEvents.g:11:7: ( 'model' )
            // InternalEvents.g:11:9: 'model'
            {
            match("model"); 
    ...
    public final void mT__13() throws RecognitionException {
        try {
            int _type = T__13;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEvents.g:12:7: ( 'package' )
            // InternalEvents.g:12:9: 'package'
            {
            match("package"); 
    ...
    public final void mT__14() throws RecognitionException {
        try {
            int _type = T__14;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEvents.g:13:7: ( 'EventType' )
            // InternalEvents.g:13:9: 'EventType'
            {
            match("EventType"); 
    ...
    public final void mT__18() throws RecognitionException {
        try {
            int _type = T__18;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEvents.g:17:7: ( '=' )
            // InternalEvents.g:17:9: '='
            {
            match('='); 
    ...
    public final void mT__23() throws RecognitionException {
        try {
            int _type = T__23;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEvents.g:22:7: ( '.' )
            // InternalEvents.g:22:9: '.'
            {
            match('.'); 
    ...
    public final void mT__25() throws RecognitionException {
        try {
            int _type = T__25;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEvents.g:24:7: ( 'default' )
            // InternalEvents.g:24:9: 'default'
            {
            match("default"); 
    ...
    public final void mRULE_ANNOTATION_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEvents.g:1424:24: ( '@' ( 'a' .. 'z' | '-' )+ ( ' ' | '\\t' )* ':' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ( '\\\\*' | '\\\\@' ) | ~ ( ( '\\\\' | '*' | '@' ) ) )* )
            // InternalEvents.g:1424:26: '@' ( 'a' .. 'z' | '-' )+ ( ' ' | '\\t' )* ':' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ( '\\\\*' | '\\\\@' ) | ~ ( ( '\\\\' | '*' | '@' ) ) )*
            {
            match('@'); 
            // InternalEvents.g:1424:30: ( 'a' .. 'z' | '-' )+
            int cnt1=0;
            loop1:
            do {
                int alt1=2;
            ...
            match(':'); 
            // InternalEvents.g:1424:62: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ( '\\\\*' | '\\\\@' ) | ~ ( ( '\\\\' | '*' | '@' ) ) )*
            loop4:
            do {
                int alt4=4;
                ...
                switch (alt4) {
            	case 1 :
            	    // InternalEvents.g:1424:63: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' )
            	    {
            	    match('\\'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEvents.g:1426:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalEvents.g:1426:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalEvents.g:1426:11: ( '^' )?
            int alt5=2;
            ...
            // InternalEvents.g:1426:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEvents.g:1428:10: ( ( '0' .. '9' )+ )
            // InternalEvents.g:1428:12: ( '0' .. '9' )+
            {
            // InternalEvents.g:1428:12: ( '0' .. '9' )+
            int cnt7=0;
            loop7:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEvents.g:1430:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalEvents.g:1430:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalEvents.g:1430:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // InternalEvents.g:1430:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalEvents.g:1430:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop8:
                    do {
                        int alt8=3;
                    ...
                    break;
                case 2 :
                    // InternalEvents.g:1430:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalEvents.g:1430:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop9:
                    do {
                        int alt9=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEvents.g:1432:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalEvents.g:1432:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalEvents.g:1432:24: ( options {greedy=false; } : . )*
            loop11:
            do {
                int alt11=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEvents.g:1434:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalEvents.g:1434:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalEvents.g:1434:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop12:
            do {
                int alt12=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEvents.g:1436:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalEvents.g:1436:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalEvents.g:1436:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt15=0;
            loop15:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEvents.g:1438:16: ( . )
            // InternalEvents.g:1438:18: .
            {
            matchAny(); 
    ...
    static final String DFA16