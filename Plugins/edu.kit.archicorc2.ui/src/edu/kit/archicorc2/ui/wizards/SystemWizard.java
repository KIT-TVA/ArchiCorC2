...
public class SystemWizard extends Wizard implements INewWizard {
	private SystemWizardPage page;
	...
	public void addPages() {
		page = new SystemWizardPage(selection);
		addPage(page);
	}
	...
	private void doFinish(String containerName, String fileName, IProgressMonitor monitor) throws CoreException {
		...
		CreateModule operation = new CreateModule(editingDomain, containerName, fileName, uri, CreationType.SYSTEM);
