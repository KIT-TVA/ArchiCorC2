...
import tu_bs.cs.isf.mapping.generator.MappingGenerator;
import tu_bs.cs.isf.mapping.parser.antlr.MappingAntlrTokenFileProvider;
import tu_bs.cs.isf.mapping.parser.antlr.MappingParser;
import tu_bs.cs.isf.mapping.parser.antlr.internal.InternalMappingLexer;
import tu_bs.cs.isf.mapping.scoping.MappingScopeProvider;
import tu_bs.cs.isf.mapping.serializer.MappingSemanticSequencer;
import tu_bs.cs.isf.mapping.serializer.MappingSyntacticSequencer;
import tu_bs.cs.isf.mapping.services.MappingGrammarAccess;
import tu_bs.cs.isf.mapping.validation.MappingConfigurableIssueCodesProvider;
import tu_bs.cs.isf.mapping.validation.MappingValidator;
...
public abstract class AbstractMappingRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "tu_bs/cs/isf/mapping/Mapping.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("tu_bs.cs.isf.mapping.Mapping");
	}
	...
	public Class<? extends ConfigurableIssueCodesProvider> bindConfigurableIssueCodesProvider() {
		return MappingConfigurableIssueCodesProvider.class;
	}
